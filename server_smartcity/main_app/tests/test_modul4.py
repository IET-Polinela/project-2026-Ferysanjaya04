...
class CRUDAndValidationTests(APITestCase):
    ...
    def test_FT_01_buat_laporan_dengan_data_lengkap(self):
        ...
        payload = {
            ...
            'description': 'Lampu jalan tidak menyala sejak kemarin malam.',
            'location': 'Jl. Merdeka',
        }
        ...
        self.assertTrue(Report.objects.filter(title='Lampu Jalan Mati').exists())
        self.assertEqual(Report.objects.get(title='Lampu Jalan Mati').reporter, self.warga)
